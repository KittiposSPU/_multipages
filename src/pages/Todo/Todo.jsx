...
function Todo() {
    ...
    useEffect(() => {
        setTodos(onlyWaiting ? todosRaw.filter(todo => !todo.completed) : todosRaw);
    ...
    function addClick(id, title) {
        const newItem = { id, title, completed: false, userTd: 1 };
    ...
    return (
        <div className='todo-container'>
                    ...
                    <Form>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            ...
                            <Form.Control
                                ...
                                value={Number(todosRaw.reduce((prev, todo) => todo.id > prev ? todo.id : prev, 0)) + 1}
                                ref={newIdRef} />
                        </Form.Group>
            ...
            <div>
                <button
                    className={'todo-space btn ' + (curPage <= 1 ? 'btn-outline-secondary' : 'btn-outline-primary')}
                ...
                <button
                    className={'todo-space btn ' + (curPage >= numPages ? 'btn-outline-secondary' : 'btn-outline-primary')}
